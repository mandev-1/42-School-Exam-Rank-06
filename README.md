...
> **IF YOU DONT KNOW WHAT IS A SOCKET.... then dont worry, it is just a fancy way of giving clients a cool ID; "parking place" (=> assigning them a socket). Think of it as a virtual File Descriptor:**
